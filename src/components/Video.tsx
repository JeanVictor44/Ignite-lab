            ...
            <div className='p-8 max-w-[1100px] mx-auto'>
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex flex-col gap-4 ">
                        <a href='' className='p-4 text-sm bg-green-500 flex items-center justify-center rounded font-bold uppercase gap-2'>
                            <DiscordLogo size={24}/>
                            Comunidade Do discord
                        </a>

                        <a href='' className='p-4 text-sm border border-blue-500 text-blue-500 flex items-center justify-center rounded font-bold uppercase gap-2'>
                            <Lightning size={24} />
                            Acesse o desafio
                        </a>
                    </div>
