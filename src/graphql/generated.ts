...
export type GetLesosnBySlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLesosnBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', videoId: string, title: string, description?: string | null, teacher?: { __typename?: 'Teacher', avatarURL: string, bio: string, name: string } | null } | null };
...
export const GetLesosnBySlugDocument = gql`
...
/**
 * __useGetLesosnBySlugQuery__
 *
 * To run a query within a React component, call `useGetLesosnBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLesosnBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLesosnBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLesosnBySlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLesosnBySlugQuery, GetLesosnBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLesosnBySlugQuery, GetLesosnBySlugQueryVariables>(GetLesosnBySlugDocument, options);
      }
export function useGetLesosnBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLesosnBySlugQuery, GetLesosnBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLesosnBySlugQuery, GetLesosnBySlugQueryVariables>(GetLesosnBySlugDocument, options);
        }
export type GetLesosnBySlugQueryHookResult = ReturnType<typeof useGetLesosnBySlugQuery>;
export type GetLesosnBySlugLazyQueryHookResult = ReturnType<typeof useGetLesosnBySlugLazyQuery>;
export type GetLesosnBySlugQueryResult = Apollo.QueryResult<GetLesosnBySlugQuery, GetLesosnBySlugQueryVariables>;
